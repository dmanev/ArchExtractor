...
import unittest
import umlgen.Base.SwComponent.PortInterface.RequiredPort
#Start of user code imports
#End of user code

class RequiredPortTest(unittest.TestCase):
    def setUp(self):
        #self._testInstance = umlgen.Base.SwComponent.PortInterface.RequiredPort.RequiredPort()
