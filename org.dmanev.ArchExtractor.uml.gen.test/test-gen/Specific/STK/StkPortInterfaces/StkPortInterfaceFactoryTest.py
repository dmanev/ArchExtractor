...
import unittest
import Specific.STK.StkPortInterfaces.StkPortInterfaceFactory
#Start of user code imports
#End of user code

class StkPortInterfaceFactoryTest(unittest.TestCase):
    def setUp(self):
        self._testInstance = Specific.STK.StkPortInterfaces.StkPortInterfaceFactory.StkPortInterfaceFactory()
